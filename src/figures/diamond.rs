...
impl Figure for Diamond {
    fn render(&self, frame: &mut Frame) {
        let mut builder = Builder::new();

        builder.move_to(Point::new(self.pos.x, self.pos.y - self.h / 2.0));
        builder.line_to(Point::new(self.pos.x + self.w / 2.0, self.pos.y));
        builder.line_to(Point::new(self.pos.x, self.pos.y + self.h / 2.0));
        builder.line_to(Point::new(self.pos.x - self.w / 2.0, self.pos.y));
        builder.close();
